          ...
          <section className="space-y-4">
            ...
            <div className="pl-9 space-y-3">
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mt-3">
                ...
                <Link href="mailto:privacy@yourthumbnailai.com" className="text-green-600 hover:text-green-700 font-semibold">
                  privacy@yourthumbnailai.com
          ...
          <section className="space-y-4">
            ...
            <div className="pl-9 space-y-3">
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 sm:p-6 border border-green-200">
                ...
                <p className="text-sm sm:text-base text-gray-700">
                  Support:{' '}
                  <Link href="mailto:support@yourthumbnailai.com" className="text-green-600 hover:text-green-700 font-semibold">
